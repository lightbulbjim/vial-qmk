...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_MINS, KC_EQL,  KC_LBRC,    KC_RBRC,          KC_NO,               KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_BSLS,       KC_VOLU,
        KC_TRNS, MO(2),   KC_NO,   LGUI(KC_LBRC), LGUI(KC_RBRC), KC_NO,               KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_NO,         KC_VOLD,
